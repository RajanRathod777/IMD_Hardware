  ...
  return (
    <div className="shadow-sm fixed top-0 left-0 w-full z-50">
      <header className="bg-[var(--color-surface)] px-2 py-1">
        ...
        {/* Mobile Bottom Menu */}
        <div className="w-full shadow-[0px_1px_5px_0px_rgba(0,0,0,0.1)] fixed bottom-0 left-0 z-50 bg-[var(--color-surface)]  max-[1035px]:block hidden">
          <div className="grid grid-cols-5 text-center px-2 py-1 ">
            {navItems.map(({ to, label, icon: Icon }) => {
              const isActive = pathname === to;
